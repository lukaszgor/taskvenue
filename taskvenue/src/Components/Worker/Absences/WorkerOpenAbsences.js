...
const WorkerOpenAbsences = () => {
    ...
    const fetchAbsences = async (idConfig,userID) => {
    ...
    const handleButtonClickAbsenceDetails = (absence) => {
        navigate('/WorkerAbsenceDetails/' + absence.id)
    };
...
export default WorkerOpenAbsences;
